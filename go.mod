...
replace github.com/sagernet/sing-box => github.com/laoxiechuzheng/sing-box v1.14.0-alpha.2.0.20260316103356-2e665cb7e295

replace github.com/xtls/xray-core => github.com/laoxiechuzheng/Xray-core v0.0.0-20260409213332-f47935539965
